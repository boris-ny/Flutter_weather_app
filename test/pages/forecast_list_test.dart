...
void main() {
  testWidgets('Forecast List widget UI test', (WidgetTester tester) async {
    // Build the widget
    ...
    // Verify if the forecast items are present
    expect(find.byType(ForecastItem), findsNWidgets(5));

    // Verify if the day, condition, and temperature texts are displayed correctly
